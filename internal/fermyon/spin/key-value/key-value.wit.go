...
//
//go:nosplit
func Open(name string) (result cm.ErrResult[Store, Error]) {
...
//go:noescape
func wasmimport_Open(name0 *uint8, name1 uint32, result *cm.ErrResult[Store, Error])
...
//
//go:nosplit
func Get(store Store, key string) (result cm.ErrResult[cm.List[uint8], Error]) {
	store0 := (uint32)(store)
...
//go:noescape
func wasmimport_Get(store0 uint32, key0 *uint8, key1 uint32, result *cm.ErrResult[cm.List[uint8], Error])
...
//
//go:nosplit
func Set(store Store, key string, value cm.List[uint8]) (result cm.ErrResult[struct{}, Error]) {
	store0 := (uint32)(store)
	key0, key1 := cm.LowerString(key)
...
//go:noescape
func wasmimport_Set(store0 uint32, key0 *uint8, key1 uint32, value0 *uint8, value1 uint32, result *cm.ErrResult[struct{}, Error])
...
//
//go:nosplit
func Delete(store Store, key string) (result cm.ErrResult[struct{}, Error]) {
	store0 := (uint32)(store)
	key0, key1 := cm.LowerString(key)
...
//go:noescape
func wasmimport_Delete(store0 uint32, key0 *uint8, key1 uint32, result *cm.ErrResult[struct{}, Error])
...
//
//go:nosplit
func Exists(store Store, key string) (result cm.ErrResult[bool, Error]) {
	store0 := (uint32)(store)
	key0, key1 := cm.LowerString(key)
...
//go:noescape
func wasmimport_Exists(store0 uint32, key0 *uint8, key1 uint32, result *cm.ErrResult[bool, Error])
...
//
//go:nosplit
func GetKeys(store Store) (result cm.ErrResult[cm.List[string], Error]) {
	store0 := (uint32)(store)
...
//go:noescape
func wasmimport_GetKeys(store0 uint32, result *cm.ErrResult[cm.List[string], Error])
